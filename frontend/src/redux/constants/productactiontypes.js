...
export const ALL_RECOMMEND_PRODUCT_REQUEST = 'ALL_RECOMMEND_PRODUCT_REQUEST';
export const ALL_RECOMMEND_PRODUCT_SUCCESS = 'ALL_RECOMMEND_PRODUCT_SUCCESS';
export const ALL_RECOMMEND_PRODUCT_FAIL = 'ALL_RECOMMEND_PRODUCT_FAIL';
